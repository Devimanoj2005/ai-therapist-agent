    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <nav className="border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Serenity</h1>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Real-Time Chat</h4>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Mood Tracking</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Wellness Tools</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Safe & Private</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">
      ...
      <section className="max-w-6xl mx-auto px-4 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-8 h-96 flex items-center justify-center border border-blue-100 dark:border-blue-900/50">
            <div className="text-center">
              <Heart className="w-24 h-24 text-blue-500 dark:text-blue-400 mx-auto mb-4 opacity-50" />
      ...
      {/* CTA Section */}
      <section className="bg-blue-500 dark:bg-blue-900 py-16">
